          ...
          >
            <div className="space-y-6">
              <h2 className="text-4xl font-mono font-bold md:text-xl">
                <span className="text-gradient glitch relative inline-block" data-text="origin.story">
                  origin.story
                </span>
              </h2>
              ...
              <div className="space-y-6 text-foreground/80">
                <div className="space-y-4">
                  ...
                  <div className="space-y-2">
                    <p className="text-lg font-mono">[I AM] faiz [feyz] :: pronounced like 'phase'</p>
                    <ul className="list-none space-y-1 font-mono text-base">
                      <li>↳ creative director | designer | photographer</li>
                      <li>↳ forged in CA, refined in NY</li>
                      <li>↳ immigrant-coded, future-loaded</li>
                    </ul>
                  </div>
                </div>

                <div className="space-y-4">
                  <h3 className="text-xl font-mono text-primary">[ORIGIN.PROTOCOL]</h3>
            ...
            <div className="pt-6">
              <h3 className="text-xl font-mono mb-6 text-primary">[SKILL.SET]</h3>
